...
<body>
<FORM action=../tomcj.asp method=post name=id>
<table class="tableBorder" width="98%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td background="../../admin/images/manage/admin_bg_1.gif"><table class="tableBorder" width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr> 
            <td width="40%" align="center" bgcolor="#FFFFFF"><span class="nr">采集音乐起始ID：</span> 
              <input type="text" name="Eid">
            </td>
            <td width="40%" align="center" bgcolor="#FFFFFF"><span class="nr">采集音乐结束ID：</span> 
              <input type="text" name="Sid">
            </td>
            <td align="center" bgcolor="#FFFFFF">
<INPUT class=buttonface name=change type=submit value=开始采集>
            </td>
        </tr>
      </table></td>
  </tr>
...
<br>
  <table class="tableBorder" width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
    <td align="center" class="nr"><strong>TOM歌词采集</strong></td>
    </tr>
  </table>
</form>
</body>
